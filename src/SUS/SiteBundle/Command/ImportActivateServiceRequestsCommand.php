...
class ImportActivateServiceRequestsCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($xls->getRowIterator(2) as $row) {
            ...
            $circuit = $em->getRepository('SUS\SiteBundle\Entity\Circuits\PhoneCircuit')->findOneBy(array(
            ...
            if(isset($circuit)) {
                ...
                $connectivityType = $em->getRepository('SUS\SiteBundle\Entity\Circuits\ConnectivityType')->findOneBy(array(
                ...
                // End circuit type
                // Bandwidth profile
                $bandwidthProfile = $em->getRepository('SUS\SiteBundle\Entity\Circuits\BandwidthProfile')->findOneBy(array(
            ...
            $request = $em->getRepository('SUS\SiteBundle\Entity\Requests\ActivateServiceRequest')->findOneBy(array(
                'number' => ($fields['conphone']),
            ));
            if(isset($request)) {
