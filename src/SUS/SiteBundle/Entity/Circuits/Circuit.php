...
/**
 * @ORM\Table
 * @ORM\Entity(repositoryClass="SUS\SiteBundle\Entity\Repositories\Circuits\CircuitsRepository")
...
abstract class Circuit extends MMSyncableEntity
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="SUS\SiteBundle\Entity\Requests\NewCircuitRequest", inversedBy="circuit")
