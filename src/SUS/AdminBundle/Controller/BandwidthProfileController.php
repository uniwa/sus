...
class BandwidthProfileController extends Controller {
    ...
    public function getBandwidthProfilesAction() {
        $repo = $this->container->get('doctrine')->getManager()->getRepository('SUS\SiteBundle\Entity\Circuits\BandwidthProfile');
        $connTypeRepo = $this->container->get('doctrine')->getManager()->getRepository('SUS\SiteBundle\Entity\Circuits\ConnectivityType');
